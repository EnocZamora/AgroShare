...
Este repositorio contiene actualmente el marco base del frontend y la estructura arquitectónica del software, preparado para la integración de los módulos de lógica de negocio.git 
